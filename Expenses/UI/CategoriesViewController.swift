...
class CategoriesViewController: NavigationViewController, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate, UITextFieldDelegate  {
    ...
    var categories: NSFetchedResultsController<Category> = Category.fetchResultsController()
    ...
    func addCategory() {
        ...
        if let name = textFieldToAdd.text {
            ...
            DataManager.createCategory(name: name.trimmed())
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: UITableViewCell = tableView.dequeueReusableCell(withIdentifier: EditableTableViewCell.identifier, for: indexPath)
